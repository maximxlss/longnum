...
void test_longnum_conversion() {
    assert_eq("1011011001111100.1100100111111100100100001010001100111101100101001011000010000101"_longnum, "46716.78901008592"_longdecimal);
    assert_eq("0.00000000000000000000000000001000001101100100010000100100001000001100000011010010101011100100"_longnum, "0.00000000191199994903277"_longdecimal);
    assert_eq("11000010100110011111.000001111001010011101010100011101"_longnum, 797087.0296160315_longnum);
    assert_eq("100000000000"_longdecimal, LongNum(1e11));
    assert_eq("-110110001011011.11001010001000011101010100110000100101"_longnum, -27739.78957874714_longnum);
    assert_eq("0.000000000000000000000000000000000000000000011000001011110111010100011101000001010111011011001011"_longnum, .00000000000008592373304639695_longnum);
...
void test_longnum_division() {
    ...
    assert_eq("5574748814014767969.4849916185514"_longdecimal / "25521421424.52151324364"_longdecimal, "1101000001010000101000110111.10110011001100011011111100100011100111001110011101011001100011"_longnum);
    assert_eq("14767969.4849916153285514"_longdecimal / ".000513243642421412"_longdecimal, "11010110011000011010101010011110011.10111100001011010101110101000000011010011011001000010101101"_longnum);
}
